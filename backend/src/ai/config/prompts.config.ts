    ...
    subjects: {
        ...
        quantReasoning: {
            ...
            shortcuts: {
                ...
                'ages': "For 'Age' problems, establish a clear timeline. Calculate the exact year offset for the requested event (e.g. at birth, or when child is 5). Make sure to add this exact offset to *every* family member's base age before calculating the new average or total.",
